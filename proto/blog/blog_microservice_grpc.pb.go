...
type BlogServiceClient interface {
	GetAllBlogs(ctx context.Context, in *GetAllRequestB, opts ...grpc.CallOption) (*GetBlogsResponse, error)
...
func (c *blogServiceClient) GetAllBlogs(ctx context.Context, in *GetAllRequestB, opts ...grpc.CallOption) (*GetBlogsResponse, error) {
...
type BlogServiceServer interface {
	GetAllBlogs(context.Context, *GetAllRequestB) (*GetBlogsResponse, error)
...
func (UnimplementedBlogServiceServer) GetAllBlogs(context.Context, *GetAllRequestB) (*GetBlogsResponse, error) {
...
func _BlogService_GetAllBlogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).GetAllBlogs(ctx, req.(*GetAllRequestB))
	}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "blog/blog_microservice.proto",
}
